                            ...
                            <div class="panel-body">
                                <form class="edit-docotr-form" role="form" name="dcotorspcl" method="post" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="appointmentpatientid" class="form-control"  placeholder="Enter Patient ID"  required="true">
                                    </div>
                                    <button id="editdoctorspecilization" type="submit" name="submit" class="btn btn-o btn-primary">Submit</button>
                                    <input type="hidden" name="action" value="admin-addappointment">
                                </form>
